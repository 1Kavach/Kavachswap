//! Instruction dispatcher. Discriminator byte 0: 0=Init, 1=Swap, 2=AddLiq, 3=RemoveLiq, 4=CollectFees.
...
use crate::instructions::{add_liquidity, collect_fees, initialize_pool, remove_liquidity, swap};
