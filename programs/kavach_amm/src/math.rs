//! AMM math: constant product, LP mint, fee split. Overflow-safe.
...
/// LP tokens to mint. First depositor: sqrt(a*b); else min(a*lp_supply/reserve_a, b*lp_supply/reserve_b).
